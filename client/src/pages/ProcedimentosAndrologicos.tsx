...
function ProcedureSection({ proc, index }: { proc: Procedure; index: number }) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-card rounded-xl border border-[#1C3D5A]/6 overflow-hidden">
        {/* Header */}
        <div className={`bg-${proc.color}-50 p-6 lg:p-8`}>
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-xl lg:text-2xl font-serif text-[#1C3D5A] dark:text-foreground">{proc.name}</h2>
              <div className="flex items-center gap-3 mt-1 text-xs text-[#1C3D5A] dark:text-foreground/40">
          ...
          <p className="text-sm text-[#1C3D5A] dark:text-foreground/60 leading-relaxed">{proc.whatIs}</p>
        </div>
        ...
        <div className="p-6 lg:p-8 space-y-6">
          {/* Indications */}
          <div>
            <h3 className="text-sm font-semibold text-[#1C3D5A] dark:text-foreground mb-3">Indicações</h3>
            <div className="space-y-1.5">
              {proc.indications.map((ind, i) => (
                <div key={i} className="flex items-start gap-2">
                  <Check className="w-3.5 h-3.5 mt-0.5 shrink-0 text-amber-500" />
                  <span className="text-xs text-[#1C3D5A] dark:text-foreground/60">{ind}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-[#F8FAFB] rounded-lg p-4">
            <h3 className="text-sm font-semibold text-[#1C3D5A] dark:text-foreground mb-2">Como é realizado</h3>
            <p className="text-xs text-[#1C3D5A] dark:text-foreground/55 leading-relaxed">{proc.howItWorks}</p>
          </div>
          ...
          {/* Recovery */}
          <div>
            <h3 className="text-sm font-semibold text-[#1C3D5A] dark:text-foreground mb-3">Recuperação</h3>
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={i} className="bg-[#F8FAFB] rounded-lg p-3">
                  <h4 className="text-[10px] uppercase tracking-wider font-semibold text-[#1C3D5A] dark:text-foreground/40 mb-1">{r.label}</h4>
                  <p className="text-xs text-[#1C3D5A] dark:text-foreground/60 leading-relaxed">{r.value}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-12 lg:py-16 bg-[#F8FAFB]">
        <div className="container max-w-3xl">
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 lg:p-8">
            <h3 className="text-lg font-semibold text-[#1C3D5A] dark:text-foreground mb-3 flex items-center gap-2">
              <Shield className="w-5 h-5 text-amber-600" />
              Vacinação contra HPV — A Melhor Prevenção
            </h3>
            <div className="space-y-3 text-sm text-[#1C3D5A] dark:text-foreground/60 leading-relaxed">
              <p>
