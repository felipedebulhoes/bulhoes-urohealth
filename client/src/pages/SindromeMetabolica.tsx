    ...
    >
      ...
      <section className="py-12 lg:py-16 bg-[#F8FAFB]">
        <div className="container max-w-4xl">
          ...
          <div className="bg-white rounded-xl border border-[#0A2540]/6 p-6 lg:p-8">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[#0A2540] mb-1">Obesidade → ↓ Testosterona</h4>
                    <p className="text-xs text-[#0A2540]/55 leading-relaxed">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[#0A2540] mb-1">↓ Testosterona → Mais Obesidade</h4>
                    <p className="text-xs text-[#0A2540]/55 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[#0A2540] mb-1">Perda de Peso → ↑ Testosterona</h4>
                    <p className="text-xs text-[#0A2540]/55 leading-relaxed">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[#0A2540] mb-1">Exercício → Quebra o Ciclo</h4>
                    <p className="text-xs text-[#0A2540]/55 leading-relaxed">
      ...
      <section className="py-12 lg:py-16">
        <div className="container max-w-4xl">
          ...
          <p className="text-center text-sm text-[#0A2540]/50 mb-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3">
            {criterios.map((c, i) => (
              <motion.div
                ...
                className="bg-white rounded-xl border border-[#0A2540]/6 p-4 text-center"
              >
                <div className="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center text-red-500 mx-auto mb-2">
                  {c.icon}
                </div>
                <h4 className="text-xs font-semibold text-[#0A2540] mb-1">{c.name}</h4>
      ...
      <section className="py-12 lg:py-16 bg-[#F8FAFB]">
        <div className="container max-w-4xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-xs text-[#0A2540]/40 text-center mt-3">O exercício de resistência é fundamental para manutenção da massa muscular e dos níveis de testosterona</p>
          </div>
              ...
              >
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-[#0A2540]">{ex.type}</h3>
                      <p className="text-xs text-[#0A2540]/40">{ex.recommendation}</p>
                    </div>
                  </div>
                  <p className="text-xs text-[#0A2540]/50 mb-3"><strong>Exemplos:</strong> {ex.examples}</p>
                  <div className="grid sm:grid-cols-2 gap-2 mb-4">
                    {ex.benefits.map((b, j) => (
                      <div key={j} className="flex items-start gap-2 bg-[#F8FAFB] rounded-lg p-2.5">
                        ...
                        <span className="text-xs text-[#0A2540]/55">{b}</span>
                      </div>
                    ))}
                  </div>
          ...
          <div className="space-y-3">
            {[
              ...
              >
                ...
                <div>
                  <h3 className="text-sm font-semibold text-[#0A2540] mb-1">{rec.title}</h3>
                  <p className="text-xs text-[#0A2540]/55 leading-relaxed">{rec.detail}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-12 lg:py-16 bg-[#F8FAFB]">
        <div className="container max-w-3xl">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6 lg:p-8">
            <h3 className="text-lg font-semibold text-[#0A2540] mb-3">Mensagem Principal</h3>
