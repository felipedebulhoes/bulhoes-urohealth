    ...
    <section id="sobre" className="py-20 lg:py-28 bg-white" ref={ref}>
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            <p className="text-base lg:text-lg text-[#0A2540]/70 leading-relaxed mb-6">
            ...
            <p className="text-base lg:text-lg text-[#0A2540]/70 leading-relaxed mb-8">
            ...
            {/* Thin divider */}
            <div className="h-px bg-[#0A2540]/10 mb-8" />
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {credentials.map((cred, i) => (
                ...
                >
                  <div className="w-9 h-9 rounded-md bg-[#0D9488]/10 flex items-center justify-center shrink-0 mt-0.5">
                    <cred.icon className="w-4 h-4 text-[#0D9488]" />
                  </div>
                  <div>
                    <h4 className="text-sm font-semibold text-[#0A2540] font-sans mb-1">{cred.title}</h4>
                    <p className="text-xs text-[#0A2540]/55 font-sans leading-relaxed">{cred.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
