    ...
    >
      ...
      <section className="py-12 lg:py-16 bg-[#F8FAFB]">
        <div className="container max-w-5xl">
          <h2 className="text-2xl lg:text-3xl text-[#0A2540] mb-3 text-center font-serif">Sinais e Sintomas</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {symptoms.map((s, i) => (
              <motion.div
                ...
                className="bg-white rounded-xl border border-[#0A2540]/6 p-5 hover:shadow-md transition-shadow"
              >
                <div className="w-10 h-10 rounded-lg bg-violet-50 flex items-center justify-center text-violet-600 mb-3">
                  {s.icon}
                </div>
                <h3 className="text-sm font-semibold text-[#0A2540] mb-1">{s.title}</h3>
                  ...
                  <div className="space-y-1.5">
                    {opt.disadvantages.map((d, j) => (
                      <div key={j} className="flex items-start gap-2">
                        ...
                        <span className="text-xs text-[#0A2540]/55">{d}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <tbody>
                {monitoramento.map((m, i) => (
                  <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-[#F8FAFB]"}>
                    <td className="p-3 font-medium text-[#0A2540] border-t border-[#0A2540]/5">{m.item}</td>
                    <td className="p-3 text-center text-[#0A2540]/60 border-t border-[#0A2540]/5">{m.timing}</td>
                    <td className="p-3 text-[#0A2540]/60 border-t border-[#0A2540]/5">{m.target}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="space-y-3">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.06 }}
                className="flex items-center gap-4 bg-white rounded-lg p-4 border border-[#0A2540]/6"
              >
                <Check className="w-5 h-5 shrink-0 text-emerald-500" />
                <div className="flex-1">
                  <span className="text-sm font-medium text-[#0A2540]">{b.benefit}</span>
                  <span className="text-xs text-[#0A2540]/40 ml-2">({b.timeline})</span>
                </div>
                <span className="text-[10px] text-[#0D9488] font-medium shrink-0 hidden sm:block">{b.evidence}</span>
              </motion.div>
            ))}
          </div>
        </div>
