      ...
      <section className="py-16 bg-white dark:bg-card">
        <div className="container max-w-4xl">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1} className="mb-14">
            <h2 className="text-2xl lg:text-3xl text-[#1C3D5A] dark:text-foreground font-serif mb-6">O que é a Litotripsia a Laser?</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-card border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-bold text-[#1C3D5A] dark:text-foreground mb-3">Laser Holmium:YAG (Ho:YAG)</h3>
              ...
              <div className="bg-white dark:bg-card border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-bold text-[#1C3D5A] dark:text-foreground mb-3">Thulium Fiber Laser (TFL)</h3>
                <p className="text-[#334155] text-sm leading-relaxed mb-3">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={2} className="mb-14">
            <h2 className="text-2xl lg:text-3xl text-[#1C3D5A] dark:text-foreground font-serif mb-6">Como é Realizada a Litotripsia a Laser?</h2>
            <p className="text-[#334155] leading-relaxed mb-6">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex gap-4 bg-gray-50 dark:bg-card rounded-xl p-5 border border-gray-100">
                  <div className="w-10 h-10 bg-[#2563EB] rounded-full flex items-center justify-center shrink-0 text-white font-bold text-sm">
                    {item.step}
                  </div>
                  <div>
                    <h4 className="font-bold text-[#1C3D5A] dark:text-foreground mb-1 flex items-center gap-2">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={3} className="mb-14">
            <h2 className="text-2xl lg:text-3xl text-[#1C3D5A] dark:text-foreground font-serif mb-6">Técnicas de Litotripsia a Laser</h2>
            <p className="text-[#334155] leading-relaxed mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-gradient-to-br from-blue-50 to-white border border-blue-100 rounded-xl p-6">
                <h3 className="text-lg font-bold text-[#1C3D5A] dark:text-foreground mb-3 flex items-center gap-2">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={4} className="mb-14">
            <h2 className="text-2xl lg:text-3xl text-[#1C3D5A] dark:text-foreground font-serif mb-6">Indicações: Quando a Litotripsia a Laser é Recomendada?</h2>
            <p className="text-[#334155] leading-relaxed mb-6">
            ...
            {/* Tabela comparativa */}
            <h3 className="text-xl font-bold text-[#1C3D5A] dark:text-foreground mb-4">Comparação: Litotripsia a Laser (URS) vs. LECO vs. PCNL</h3>
            <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-border mb-4">
                ...
                <tbody>
                  {[
                    ...
                    <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50 dark:bg-card"}>
                      <td className="p-3 font-medium text-[#1C3D5A] dark:text-foreground">{row[0]}</td>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={5} className="mb-14">
            <h2 className="text-2xl lg:text-3xl text-[#1C3D5A] dark:text-foreground font-serif mb-6">Preparo para o Procedimento</h2>
            <p className="text-[#334155] leading-relaxed mb-6">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3 bg-gray-50 dark:bg-card rounded-lg p-4 border border-gray-100">
                      ...
                      <div>
                        <h4 className="font-bold text-[#1C3D5A] dark:text-foreground text-sm">{item.title}</h4>
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-100">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between bg-white dark:bg-card rounded-lg p-3 border border-green-100">
              ...
              <div className="bg-amber-50 rounded-xl p-6 border border-amber-100">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between bg-white dark:bg-card rounded-lg p-3 border border-amber-100">
                      <span className="text-sm text-[#334155]">{item.name}</span>
              ...
              <div className="bg-red-50 rounded-xl p-6 border border-red-100">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between bg-white dark:bg-card rounded-lg p-3 border border-red-100">
                      <span className="text-sm text-[#334155]">{item.name}</span>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={8} className="mb-14">
            <h2 className="text-2xl lg:text-3xl text-[#1C3D5A] dark:text-foreground font-serif mb-6">Onde Realizamos a Litotripsia a Laser</h2>
