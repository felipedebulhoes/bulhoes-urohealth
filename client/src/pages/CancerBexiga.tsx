    ...
    >
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">O que é o Câncer de Bexiga?</h2>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-6">
            <div className="bg-purple-50 rounded-lg p-4 border border-purple-100">
              ...
              <p className="text-sm text-gray-700">
                ...
                <span className="text-xs text-gray-500">Fonte: EAU Guidelines 2026 [1]</span>
              </p>
            </div>
            <div className="bg-purple-50 rounded-lg p-4 border border-purple-100">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Fatores de Risco</h2>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Sintomas e Sinais de Alerta</h2>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Sintomas Urinários</h4>
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Sintomas de Doença Avançada</h4>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Estadiamento TNM</h2>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                    ...
                    <td className="p-3 text-gray-700 border-b border-gray-100">{row.desc}</td>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Tratamento do NMIBC (Não-Músculo Invasivo)</h2>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          <p className="text-gray-700 leading-relaxed mb-6">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Tratamento do MIBC (Músculo-Invasivo)</h2>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
          <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                    ...
                    <td className="p-3 text-gray-700 border-b border-gray-100">{row.desc}</td>
                    <td className="p-3 text-gray-600 border-b border-gray-100">{row.ind}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr className="bg-white">
                  <td className="p-3 font-semibold text-gray-700 border-b border-gray-100">Baixo Risco</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">3 meses, depois anual por 5 anos</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">Não obrigatória</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">Não obrigatória</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="p-3 font-semibold text-gray-700 border-b border-gray-100">Risco Intermediário</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">3, 6, 12 meses, depois anual por 5 anos</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">A cada cistoscopia</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">Anual</td>
                </tr>
                <tr className="bg-white">
                  <td className="p-3 font-semibold text-gray-700 border-b border-gray-100">Alto Risco</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">3, 6, 9, 12 meses, depois semestral até 5 anos, anual após</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">A cada cistoscopia</td>
                  <td className="p-3 text-gray-600 border-b border-gray-100">Anual</td>
                </tr>
              </tbody>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Onde Tratar em Campinas e São Paulo</h2>
        </div>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Referências Científicas</h2>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
