  ...
  return (
    ...
    >
      ...
      <section className="py-12 lg:py-16">
        <div className="container max-w-4xl">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#0D9488]/5 border border-[#0D9488]/10 rounded-2xl p-6 lg:p-8"
          >
      ...
      <section className="py-8 lg:py-12">
        <div className="container max-w-4xl">
          <h2 className="text-2xl lg:text-3xl text-[#0A2540] mb-8 font-serif text-center">
            Etapas da Consulta
          </h2>
          <div className="space-y-6">
            {steps.map((step, i) => (
              <motion.div
                ...
                className="bg-white rounded-xl border border-[#0A2540]/6 p-6 hover:shadow-md transition-shadow"
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[#0A2540]/5 flex items-center justify-center shrink-0 text-[#0A2540]">
                    {step.icon}
                  </div>
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[#0A2540]/55 leading-relaxed mb-4">
                      {step.description}
                    </p>
                    <div className="bg-[#F8FAFB] rounded-lg p-4">
                      <p className="text-xs font-semibold text-[#0A2540]/70 mb-2">Dicas:</p>
                      <ul className="space-y-1.5">
                        {step.tips.map((tip, j) => (
                          <li key={j} className="flex items-start gap-2 text-xs text-[#0A2540]/50">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {whatToBring.map((item, i) => (
              <motion.div
                ...
                className="bg-white rounded-xl border border-[#0A2540]/6 p-4 flex items-start gap-3"
              >
                <div className="w-9 h-9 rounded-lg bg-[#0D9488]/10 flex items-center justify-center shrink-0 text-[#0D9488]">
                  {item.icon}
                </div>
                <span className="text-sm text-[#0A2540]/70">{item.text}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 lg:py-16">
        <div className="container max-w-4xl">
          <h2 className="text-2xl lg:text-3xl text-[#0A2540] mb-3 font-serif text-center">
            Mitos e Verdades
          </h2>
          <p className="text-sm text-[#0A2540]/40 text-center mb-8 max-w-lg mx-auto">
          ...
          <div className="space-y-4">
            {myths.map((item, i) => (
              ...
              >
                ...
                <div className="flex items-start gap-3 ml-0 pl-0 border-l-2 border-[#0D9488]/30">
                  <div className="pl-4">
                    <span className="text-xs font-bold text-[#0D9488] bg-[#0D9488]/10 px-2 py-0.5 rounded inline-block mb-1">
                      VERDADE
                    </span>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-3 bg-white rounded-lg border border-[#0A2540]/6 p-3"
              >
                <ArrowRight className="w-4 h-4 text-[#0D9488] shrink-0" />
                <span className="text-sm text-[#0A2540]/70">{symptom}</span>
              </motion.div>
            ))}
          </div>
        </div>
