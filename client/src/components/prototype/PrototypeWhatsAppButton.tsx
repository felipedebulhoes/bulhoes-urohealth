...
export default function PrototypeWhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-busy={opening}
      className="group fixed bottom-5 right-4 z-50 flex min-h-14 items-center gap-3 rounded-full bg-[#128C7E] px-4 py-3 font-semibold text-white shadow-2xl shadow-black/20 transition hover:-translate-y-1 hover:bg-[#0F766E] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#128C7E] focus-visible:ring-offset-4 active:scale-[0.98] motion-reduce:transform-none sm:bottom-7 sm:right-7"
    >
