...
const locations: Record<string, LocationData> = {
  "campinas-day-hospital": {
    ...
    address: "R. Angela Signori Grigol, 299 — Jardim Chapadão",
    city: "Campinas, SP — CEP 13070-585",
    type: "convenio",
    ...
    description: "O Campinas Day Hospital é um centro cirúrgico moderno e completo, equipado com tecnologia de ponta para procedimentos urológicos. Localizado no Jardim Chapadão em Campinas, oferece atendimento por convênios e particular, com estrutura para cirurgias ambulatoriais e internação de curta permanência.",
  ...
  "clinovi-paulista": {
    ...
    hours: ["Segunda a Sexta: 8h às 20h", "Sábado: 8h às 14h"],
