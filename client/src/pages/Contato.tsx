    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[#0D9488] text-sm font-semibold uppercase tracking-[0.15em]">Fale Conosco</span>
            </div>
      ...
      <section className="py-16 lg:py-20">
        <div className="container max-w-5xl">
          <h2 className="text-2xl font-bold text-[#0A2540] mb-8">Canais de Atendimento</h2>
          <div className="grid sm:grid-cols-2 gap-4 mb-12">
            {contactChannels.map((channel, i) => (
              <motion.a
                ...
                className="bg-[#F8FAFB] rounded-xl p-5 border border-[#0A2540]/6 hover:shadow-md hover:border-[#0D9488]/30 transition-all group"
              >
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-[#0D9488]/10 flex items-center justify-center shrink-0">
                    <channel.icon className="w-5 h-5 text-[#0D9488]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-[#0A2540] text-sm mb-0.5">{channel.title}</h3>
                    <p className="text-[#0D9488] font-bold text-lg group-hover:underline">{channel.phone}</p>
          ...
          {/* Offices */}
          <h2 className="text-2xl font-bold text-[#0A2540] mb-6">Locais de Atendimento</h2>
          <div className="grid md:grid-cols-3 gap-4 mb-12">
            {offices.map((office, i) => (
              ...
              >
                <Link href={office.link} className="bg-[#F8FAFB] rounded-xl p-5 border border-[#0A2540]/6 hover:shadow-md transition-all block h-full">
                  <div className="flex items-center gap-2 mb-2">
                    <MapPin className="w-4 h-4 text-[#0D9488]" />
                    <h3 className="font-semibold text-[#0A2540] text-sm">{office.name}</h3>
                  </div>
                  <p className="text-xs text-[#64748B] mb-2">{office.address}</p>
                  <span className="text-[10px] uppercase tracking-wider font-semibold text-[#0D9488]">{office.type}</span>
                </Link>
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-[#0A2540] to-[#0D3B5C] rounded-xl p-6 flex flex-col sm:flex-row items-center gap-5 mb-12"
          >
            <div className="w-12 h-12 rounded-xl bg-[#0D9488]/20 flex items-center justify-center shrink-0">
              <Monitor className="w-6 h-6 text-[#5EEAD4]" />
            </div>
            ...
            <Link href="/agendamento">
              <Button className="bg-[#0D9488] hover:bg-[#0B7C72] text-white shrink-0">Agendar Online</Button>
            </Link>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.6 }}>
              <h2 className="text-2xl font-bold text-[#0A2540] mb-4">Informações Importantes</h2>
              <div className="space-y-4 text-sm text-[#334155] leading-relaxed">
                ...
                <div className="flex items-start gap-3">
                  <MessageCircle className="w-5 h-5 text-[#0D9488] mt-0.5 shrink-0" />
                  <div>
                    <p className="font-semibold text-[#0A2540]">WhatsApp</p>
                    <p>O WhatsApp (11) 98112-4455 é apenas para mensagens. Resposta em até 2 horas durante o horário comercial.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Phone className="w-5 h-5 text-[#0D9488] mt-0.5 shrink-0" />
                  <div>
                    <p className="font-semibold text-[#0A2540]">Agendamento por telefone</p>
              ...
              {/* Social */}
              <div className="mt-8 pt-6 border-t border-[#0A2540]/6">
                <h3 className="font-semibold text-[#0A2540] text-sm mb-3">Redes Sociais</h3>
                <div className="flex items-center gap-4">
                  <a href="https://www.instagram.com/drfelipebulhoes/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#64748B] hover:text-[#0D9488] transition-colors">
                    <Instagram className="w-5 h-5" />
                    <span className="text-sm">@drfelipebulhoes</span>
                  </a>
                  <a href="https://www.doctoralia.com.br/felipe-de-bulhoes-ojeda-2/urologista/campinas" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#64748B] hover:text-[#0D9488] transition-colors">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.7 }}>
              <div className="bg-gradient-to-br from-[#0A2540] to-[#0F3460] rounded-2xl p-6 lg:p-8">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full bg-[#0D9488] hover:bg-[#0B7C72] text-white h-12 text-sm font-semibold rounded-lg mt-2">
