...
function Accordion({ titulo, children, defaultOpen = false }: { titulo: string; children: React.ReactNode; defaultOpen?: boolean }) {
  ...
  return (
    <div className="border border-[#1C3D5A]/8 rounded-xl overflow-hidden">
      <button
    ...
    >
      ...
      <section className="mb-12 md:mb-16">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-6 bg-[#1C3D5A]/3 rounded-xl p-5 border border-[#1C3D5A]/6"
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 text-xs font-medium text-[#B87333] hover:text-[#B87333]/80 transition-colors"
              >
      ...
      <section className="mb-12 md:mb-16">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-[#1C3D5A] to-[#1C3D5A]/90 rounded-2xl p-6 md:p-8 text-white"
        >
