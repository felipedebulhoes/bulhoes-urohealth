      ...
      <div className="p-6 cursor-pointer" onClick={() => setExpanded(!expanded)}>
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-[#0A2540] mb-0.5">{treatment.name}</h3>
                ...
                <ul className="space-y-2">
                  {treatment.advantages.map((a, i) => (
                    <li key={i} className="text-xs text-emerald-800/70 flex items-start gap-2">
                      <Check className="w-3 h-3 mt-0.5 shrink-0 text-emerald-500" />{a}
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div className="container max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-xl overflow-hidden shadow-sm">
              ...
              <div className="p-4">
                <p className="text-xs text-[#0A2540]/50 text-center">Ureteroscopia com litotripsia a laser — o ureteroscópio acessa o rim pela uretra para fragmentar o cálculo</p>
              </div>
            </div>
            <div className="bg-white rounded-xl overflow-hidden shadow-sm">
              <img src={IMG.doubleJ} alt="Cateter Duplo J - ilustração" className="w-full h-auto" />
              <div className="p-4">
                <p className="text-xs text-[#0A2540]/50 text-center">Cateter duplo J posicionado entre o rim e a bexiga para garantir drenagem urinária</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-5 gap-8 items-start">
            <div className="md:col-span-3 space-y-4">
              <div className="prose prose-sm max-w-none prose-p:text-[#0A2540]/65 prose-p:leading-relaxed prose-strong:text-[#0A2540]/80 prose-headings:text-[#0A2540]">
                <h3>O que é?</h3>
                <p>
            ...
            <div className="md:col-span-2">
              <div className="bg-white rounded-xl overflow-hidden shadow-sm sticky top-24">
                ...
                <div className="p-4 space-y-3">
                  <p className="text-xs text-[#0A2540]/50 text-center">Posicionamento do cateter duplo J no trato urinário</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {preventionTips.map((tip, i) => (
              ...
              >
                ...
                <h3 className="text-sm font-semibold text-[#0A2540] mb-2">{tip.title}</h3>
                <p className="text-xs text-[#0A2540]/55 leading-relaxed mb-2">{tip.detail}</p>
                <p className="text-[10px] text-[#0D9488] font-medium">{tip.source}</p>
              </motion.div>
            ))}
          </div>
          <div className="mt-8">
            ...
            <p className="text-xs text-[#0A2540]/40 text-center mt-3">Medidas dietéticas para prevenção de cálculos renais</p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            {[
              ...
              >
                ...
                <p className="text-sm text-[#0A2540]/60 leading-relaxed">{item.rec}</p>
              </motion.div>
            ))}
          </div>
        </div>
